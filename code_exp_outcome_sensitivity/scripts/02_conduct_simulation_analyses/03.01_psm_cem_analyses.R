...
source("./scripts/02_conduct_simulation_analyses/02.01_conduct_psm_function.R")
...
# run R script to obtain function to conduct matching
source("./scripts/02_conduct_simulation_analyses/02.02_conduct_cem_function.R")
...
# change survey package global settings to adjust for strata with one PSU
# this will advoid the errors that will appear otherwise
...
saveRDS(list_effect_or, file =  paste0("./data/simulation_results/main_results/analyses_effect_", df_num, ".RData"))
saveRDS(list_se, file =  paste0("./data/simulation_results/main_results/analyses_se_", df_num, ".RData"))
