...
save(list_cem_effect_or, list_cem_se, file = paste0("./data/simulation_results/main_results/cem_analyses", specify_df, ".RData")) # adjust path to specify which simulated data frame was used

# save balance metrics
save(balance_avg_cem, file = paste0("./data/simulation_results/main_results/balance_avg_cem", specify_df, ".RData")) # adjust path to specify which simulated data frame was used
