...
source("./scripts/02_conduct_simulation_analyses/04_confounding_sensitivity_analyses/02_remove_bmi_analyses/02.02_conduct_cem_function_no_bmi.R")
...
save(list_cem_effect_or, list_cem_se, file = paste0("./data/simulation_results/confounding_sensitivity_results/remove_bmi_results/cem_analyses_no_bmi", specify_df, ".RData")) # adjust path to specify which simulated data frame was used

# save balance metrics
save(balance_avg_cem, file = paste0("./data/simulation_results/confounding_sensitivity_results/remove_bmi_results/balance_avg_cem_no_bmi", specify_df, ".RData")) # adjust path to specify which simulated data frame was used
