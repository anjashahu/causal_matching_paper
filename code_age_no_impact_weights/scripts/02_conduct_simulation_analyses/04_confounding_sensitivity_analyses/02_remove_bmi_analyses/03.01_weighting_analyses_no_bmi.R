...
source("./scripts/02_conduct_simulation_analyses/04_confounding_sensitivity_analyses/02_remove_bmi_analyses/02.03_conduct_weighting_function_no_bmi.R")
...
save(list_weighting_effect_or, list_weighting_se, file = paste0("./data/simulation_results/confounding_sensitivity_results/remove_bmi_results/weighting_analyses_no_bmi", specify_df, ".RData")) # adjust path to specify which simulated data frame was used

# save balance metrics
save(balance_avg_weighting, file = paste0("./data/simulation_results/confounding_sensitivity_results/remove_bmi_results/balance_avg_weighting_no_bmi", specify_df, ".RData")) # adjust path to specify which simulated data frame was used
