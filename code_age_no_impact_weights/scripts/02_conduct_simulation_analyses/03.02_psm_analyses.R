...
save(list_psm_effect_or, list_psm_se, file = paste0("./data/simulation_results/main_results/psm_analyses", specify_df, ".RData")) # adjust path to specify which simulated data frame was used

# save balance metrics
save(balance_avg_psm, file = paste0("./data/simulation_results/main_results/balance_avg_psm", specify_df, ".RData")) # adjust path to specify which simulated data frame was used
