...
source("./scripts/02_conduct_simulation_analyses/04_confounding_sensitivity_analyses/01_remove_age_analyses/02.01_conduct_psm_function_no_age.R")
...
save(list_psm_effect_or, list_psm_se, file = paste0("./data/simulation_results/confounding_sensitivity_results/remove_age_results/psm_analyses_no_age", specify_df, ".RData")) # adjust path to specify which simulated data frame was used

# save balance metrics
save(balance_avg_psm, file = paste0("./data/simulation_results/confounding_sensitivity_results/remove_age_results/balance_avg_psm_no_age", specify_df, ".RData")) # adjust path to specify which simulated data frame was used
